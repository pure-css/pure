  ...
  return (
    <Layout description={description} title={title}>
      ...
      <div className="content">
          <aside>
              <p>
                  Alternatively, you can <a href="https://github.com/pure-css/pure-release/archive/v1.0.1.zip">download Pure</a>, or <a href="/customize/">check out other CDNs</a> that host Pure.
              </p>
          </aside>
          <h2 id="add-the-viewport-meta-element" className="content-subhead">
            Add the Viewport Meta Element
            <a href="#add-the-viewport-meta-element" className="content-link" title="Heading anchor"></a>
          </h2>
          <p>
      ...
      <div className="content">
          <h2 id="understand-pure-grids" className="content-subhead">
              ...
              <a href="#understand-pure-grids" className="content-link" title="Heading anchor"></a>
          </h2>
          <p>
...
<div class="pure-u-1-3"><p>Thirds</p></div>
      ...
      <div className="content">
          <h2 id="responsive-grids" className="content-subhead">
              Responsive Grids
