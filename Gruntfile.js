module.exports = function(grunt) {
  ...
  /*
    The following code is for tasks related to
    importing Normalize.css into the library as base.css.

    I've wrapped all of this code in a self-executing function
    for some variable closure.
  */

  var ImportNormalize = function () {
    var path = require('path'),
        ...
        FOLDER_PATH = 'src/base/',
        FILE_PATH = FOLDER_PATH + 'css/normalize-context.css',
        PREFIX = '.k',
        LICENSE = '/*! normalize.css v1.1.0 | MIT License | git.io/normalize */\n\n';

    grunt.registerTask('base-clean', 'Clean Source Tree', function() {
      var files = grunt.file.expand(FOLDER_PATH +'css/*.css');
    ...
    grunt.registerTask('base-import-css', 'Import Normalize CSS Files', function() {
      var file = 'normalize.css',
          ...
          dest = path.join(FOLDER_PATH + 'css', file),
          str;
    ...
    grunt.registerTask('base-import-tests', 'Import Normalize Tests', function() {
      var file = 'test.html',
          src = path.join(NORMALIZE_LIB, file),
          dest = path.join(FOLDER_PATH + 'tests', 'manual', file);
    ...
    grunt.registerTask('base-create-context', 'Make context version', function() {
        ...
        */
        ...
        ---------------------------- */
        raw = grunt.file.read(FOLDER_PATH + 'css/normalize.css');
        parser.parse(raw);
